...
public:
    ...
    unsigned fmtp_rtppayloadformat()const
    {
        return fRTPPayloadFormat;
    }
    unsigned fmrp_rtptimestampfrequency()const
    {
        return fRTPTimestampFrequency;
    };
    Boolean fmtp_cpresent() const
    {
        return fCpresent;
    }
    Boolean fmtp_randomaccessindication() const
    {
    ...
    unsigned const fmtp_width() const
    {
        return _width;
    }
    unsigned const fmtp_height() const
    {
        return _height;
    }
    int const fmtp_spsLen() const
    {
        return _spsLen;
    }
    int const fmtp_ppsLen() const
    {
        return _ppsLen;
    }
    char * fmtp_header()
    ...
    char const* fmtp_emphasis() const
    {
        return fEmphasis;
    }
    char const* fmtp_channelorder() const
    {
        return fChannelOrder;
    }
